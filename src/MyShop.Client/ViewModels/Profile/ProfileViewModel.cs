...
public partial class ProfileViewModel : BaseViewModel
{
    ...
    [ObservableProperty] private DateTimeOffset _joinedDate = DateTimeOffset.Now;
    [ObservableProperty] private string? _avatarUrl;
    [ObservableProperty] private StorageFile? _selectedAvatarFile;
    [ObservableProperty] private bool _isTrialActive;
    [ObservableProperty] private DateTimeOffset? _trialExpiryDate;
    ...
    private async Task LogoutAsync()
    {
        try
        {
            ...
            {
                rootFrame.Navigate(typeof(Views.Auth.LoginPage));
            }
