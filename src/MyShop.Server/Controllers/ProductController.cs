...
public class ProductController : ControllerBase
{
    ...
    public async Task<ActionResult<ApiResponse<ProductResponse>>> CreateAsync([FromBody] CreateProductRequest createProductRequest)
    {
        ...
        return CreatedAtRoute("GetProductById", new { id = createdProduct.Id }, ApiResponse<ProductResponse>.SuccessResponse(createdProduct, "Product created successfully", 201));
    }
