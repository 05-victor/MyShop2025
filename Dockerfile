...
COPY src/MyShop.Shared/MyShop.Shared.csproj src/MyShop.Shared/
COPY src/MyShop.Plugins/MyShop.Plugins.csproj src/MyShop.Plugins/
COPY src/MyShop.Core/MyShop.Core.csproj src/MyShop.Core/

# Restore dependencies for the server project (this will restore all dependencies)
...
RUN dotnet publish src/MyShop.Server/MyShop.Server.csproj -c Release -o /app/publish
